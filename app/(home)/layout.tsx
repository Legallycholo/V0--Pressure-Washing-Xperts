...
export const metadata: Metadata = buildPublicMetadata({
  ...
  description:
    "Professional pressure washing in Ellenwood, GA and Metro Atlanta. House washing, driveway cleaning, roof soft wash, decks, and commercial. Licensed & insured. Ready-to-book service. Call (800) 451-7213.",
  pathname: "/",
})
